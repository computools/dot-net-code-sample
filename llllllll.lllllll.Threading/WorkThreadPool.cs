...
namespace *********.**********.Threading
{
    ...
    ///   </para>
    ///   <para>
    ///   The Dispose method, performs an orderly shutdown of the <b>threads</b>.  The method
    ...
    public class WorkThreadPool : IResourcePool, IDisposable
    {
        ...
        public WorkThreadPool() : this(1, 200)
        {
        }
        ...
        private class WorkThread
        {
            ...
            public async void DoWork(IWorkItem workItem)
            {
